...
window.NMI18n = (function () {
  ...
  const dict = {
    en: {
      ...
      'stats.sub': 'Release 2026-08-29 v0.8.1 · 650,859 workspace tokens',
      ...
      'engines.lead': 'Native graph by default. Optionally delegate structure to codebase-memory-mcp (CBM) while NeuroMesh keeps folding and packets.',
      'engines.graphTitle': 'Graph backend',
      'engines.graphDesc': 'native · auto · proxy_cbm. Auto-detect reads ~/.cursor/mcp.json. Only get_context_packet uses the proxy.',
    ...
    fa: {
      ...
      'stats.sub': 'انتشار 2026-08-29 v0.8.1 · 650,859 توکن workspace',
      ...
      'engines.lead': 'گراف داخلی به‌صورت پیش‌فرض. در صورت نیاز ساختار را به codebase-memory-mcp (CBM) بسپارید؛ NeuroMesh folding و packet را نگه می‌دارد.',
      'engines.graphTitle': 'بک‌اند گراف',
      'engines.graphDesc': 'native · auto · proxy_cbm. Auto از ~/.cursor/mcp.json می‌خواند. فقط get_context_packet از پروکسی استفاده می‌کند.',
