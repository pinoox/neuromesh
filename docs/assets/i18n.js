...
window.NMI18n = (function () {
  ...
  const dict = {
    en: {
      ...
      'hero.badgeRelease': 'v0.8.3 — ready to use',
      ...
      'stats.sub': 'v0.8.3 · up to ~97% fewer tokens vs dumping the whole workspace',
    ...
    fa: {
      ...
      'hero.badgeRelease': 'نسخه 0.8.3 — آماده استفاده',
      ...
      'stats.sub': 'نسخه 0.8.3 · تا ~۹۷٪ توکن کمتر نسبت به dump کل workspace',
