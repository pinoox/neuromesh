...
window.NMI18n = (function () {
  ...
  const dict = {
    en: {
      ...
      'hero.badgeRelease': 'v0.9.10 — zero-embed fast engine · instant index',
      ...
      'stats.sub': 'v0.9.10 · default fast engine · up to ~97% fewer tokens vs attaching the whole project',
      ...
      'engines.lead': 'v0.9.10 ships with <strong>engine: fast</strong> — instant graph index, no ONNX warm. Install, index, pass your prompt — done. Opt in to <strong>hybrid</strong> / <strong>deep</strong> when you need semantic search.',
    ...
    fa: {
      ...
      'hero.badgeRelease': 'نسخه 0.9.10 — موتور fast بدون embed · index فوری',
      ...
      'stats.sub': 'نسخه 0.9.10 · engine fast پیش‌فرض · تا ~۹۷٪ توکن کمتر نسبت به attach کل پروژه',
      ...
      'engines.lead': 'نسخه 0.9.10 با <strong>engine: fast</strong> می‌آید — index گراف فوری، بدون ONNX. نصب، index، prompt — تمام. برای جستجوی معنایی <strong>hybrid</strong> / <strong>deep</strong> را فعال کنید.',
