...
The agent loop in the editor matches 0.6.4: **get_context → expand_fold**. Grep (`search_symbols`) when coverage is `partial` or `no_seed_resolved`. After a good edit, **record_feedback**.
