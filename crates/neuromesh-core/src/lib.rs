...
pub use source_path::{
    ...
    is_core_source_path, is_editors_path, is_embed_tier_noise_path, is_json_schema_path,
    is_legacy_path, is_locale_path, is_low_priority_source_path, is_name_collision_decoy,
    is_schema_path, name_match_specificity, prompt_targets_alt_surface, prompt_targets_bench,
    prompt_targets_database, prompt_targets_editors, prompt_targets_json_schema,
    prompt_targets_legacy, prompt_targets_locale, prompt_targets_types,
};
